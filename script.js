...
pessoasInput.addEventListener ("input", receberQuantiadadePessoas)

function receberQuantiadadePessoas(evento) {
...
function calcular() {
    if(conta !==0 && porcentagem !== 0 && pessoas !==0) {
        ...
        strongGorjeta.innerHTML = `R$ ${(conta * porcentagem / pessoas).toFixed(2)}`
